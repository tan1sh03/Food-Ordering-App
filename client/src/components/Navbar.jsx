...
const Navbar = () => {
  ...
  const navItems = (
    <>
      <li>
        <a href="/" className="text-blue container:mx-auto ">
         <FaHome/> Home
        </a>
      </li>

      <li>
        <a href="/menu" className="text-blue container:mx-auto ">
        ...
        <div className="navbar-end ">
         ...
         <label
          ...
          { 
            user ? <>
           <Profile user={user}/>
          </> : <button onClick={()=>document.getElementById('my_modal_5').showModal()} className="btn flex items-center gap-2 rounded-full px-6 bg-blue text-white">
            <FaRegUser /> Login
          </button>
          }
          <Modal/>
